...
procedure TfrmPreco_consulta.FormShow(Sender: TObject);
var
sImgFundo:string;
begin
...
procedure TfrmPreco_consulta.CentralizarPanel(p:TPanel);
begin
...
procedure TfrmPreco_consulta.FormResize(Sender: TObject);
begin
  CentralizarPanel(pnFundo);
end;
