...
uses
  ...
  DB, DBAccess, Menus, AdvMenus, ComCtrls, XPMan, Uni,
  AdvMetroButton, AdvSmoothPanel, AdvSmoothExpanderPanel, JvExMask,
  JvToolEdit, MemDS;
...
uses modulo, funcoes, principal, unECF, menu_fiscal, UFuncoes;
