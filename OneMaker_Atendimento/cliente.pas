...
procedure Tfrmcliente.AdvSmoothButton10Click(Sender: TObject);
begin
  PageView1.ActivePageIndex := 0;
  pg_rodape.ActivePageIndex := 1;
end;

procedure Tfrmcliente.AdvSmoothButton1Click(Sender: TObject);
begin
  PageView1.ActivePageIndex := 0;
  pg_rodape.ActivePageIndex := 0;
end;

procedure Tfrmcliente.AdvSmoothButton2Click(Sender: TObject);
begin
  PageView1.ActivePageIndex := 1;
end;

procedure Tfrmcliente.AdvSmoothButton3Click(Sender: TObject);
begin
PageView1.ActivePageIndex := 3;
end;

procedure Tfrmcliente.AdvSmoothButton4Click(Sender: TObject);
begin
  PageView1.ActivePageIndex := 4;
end;

procedure Tfrmcliente.AdvSmoothButton5Click(Sender: TObject);
begin
  PageView1.ActivePageIndex := 0;
  pg_rodape.ActivePageIndex := 3;
end;

procedure Tfrmcliente.AdvSmoothButton6Click(Sender: TObject);
begin
  PageView1.ActivePageIndex := 5;
end;

procedure Tfrmcliente.AdvSmoothButton7Click(Sender: TObject);
begin
  PageView1.ActivePageIndex := 6;
end;

procedure Tfrmcliente.AdvSmoothButton8Click(Sender: TObject);
begin
  PageView1.ActivePageIndex := 0;
  pg_rodape.ActivePageIndex := 2;
end;

procedure Tfrmcliente.AdvSmoothButton9Click(Sender: TObject);
begin
  PageView1.ActivePageIndex := 2;
end;
