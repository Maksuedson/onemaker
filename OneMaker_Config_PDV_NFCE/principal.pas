...
begin
  ...
  GravaIni('.\Cfg\cfg.ini','BALANCA','Modelo',inttostr(cb_bal_modelo.ItemIndex));
  GravaIni('.\Cfg\cfg.ini','BALANCA','Handshaking',inttostr(cb_bal_hand.ItemIndex));
  GravaIni('.\Cfg\cfg.ini','BALANCA','Parity',inttostr(cb_parity.ItemIndex));
  GravaIni('.\Cfg\cfg.ini','BALANCA','Stopbits',inttostr(cb_parity.ItemIndex));
  GravaIni('.\Cfg\cfg.ini','BALANCA','Porta',cb_bal_porta.Text);
  GravaIni('.\Cfg\cfg.ini','BALANCA','Databits',cb_bal_databits.Text);
  GravaIni('.\Cfg\cfg.ini','BALANCA','Baudrate',cb_bal_baudrate.Text);
  GravaIni('.\Cfg\cfg.ini','BALANCA','Timeout',cb_bal_time_out.Text);


  GravaIni('.\Cfg\cfg.ini','Teclado','Modelo','0');
  GravaIni('.\Cfg\cfg.ini','Teclado','Porta','COM10');

  GravaIni('.\Cfg\cfg.ini','ECF','Porta',CB_PORTA.Text);
...
begin
  ...
  conexao.close;
  conexao.Database := ExtractFilePath(Application.ExeName) + '\BD\NFCE_DATPDV.FDB';
  conexao.open;
