...
type
  Tfrmcontaspagar_pgto = class(TForm)
    ...
    procedure ccettClick(Sender: TObject);
    procedure AdvSmoothExpanderPanel1MouseDown(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure aqw789Click(Sender: TObject);
  private
...
procedure Tfrmcontaspagar_pgto.ccettClick(Sender: TObject);
begin
  frmmodulo.Conexao.Rollback;
  CLOSE;
end;

procedure Tfrmcontaspagar_pgto.AdvSmoothExpanderPanel1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  ReleaseCapture;
...
procedure Tfrmcontaspagar_pgto.aqw789Click(Sender: TObject);
begin
  ccett.Click;
end;
