...
type
  TfrmInventario = class(TForm)
    ...
    qrgrupo_tipoTOTAL: TExtendedField;
...
begin
  ...
  fXproduto.LoadFromFile('\OneMaker\server\rel\f000126.fr3');
...
procedure TfrmInventario.AdvSmoothExpanderPanel1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  ReleaseCapture;
