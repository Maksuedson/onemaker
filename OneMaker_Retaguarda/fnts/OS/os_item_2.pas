...
type
  TfrmOS_item_2 = class(TForm)
    ...
    procedure oseerrt87Click(Sender: TObject);
  private
...
procedure TfrmOS_item_2.AdvSmoothExpanderPanel1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  ReleaseCapture;
...
procedure TfrmOS_item_2.oseerrt87Click(Sender: TObject);
begin
