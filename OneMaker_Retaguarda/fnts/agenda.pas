...
uses
  ...
  ImgList, DB, Grids, DBGrids, DBGridView, Buttons,
  ExtCtrls, ZAbstractRODataset, ZAbstractDataset, ZDataset, Wwdbigrd,
  Wwdbgrid, Menus, DBCtrls, Mask, shellapi, AdvGlowButton, Collection,
  ...
  dxSkinXmas2008Blue, cxTextEdit, cxHyperLinkEdit, cxDBEdit, System.ImageList,
...
type
  Tfrmagenda = class(TForm)
    ...
    procedure bt_agenda_fecharClick(Sender: TObject);
  private
...
procedure Tfrmagenda.AdvSmoothExpanderPanel1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  ReleaseCapture;
...
procedure Tfrmagenda.bt_agenda_fecharClick(Sender: TObject);
begin
  Close;
end;
...
procedure Tfrmagenda.locEnter(Sender: TObject);
begin
  tedit(sender).color := $00A0FAF8;
end;

procedure Tfrmagenda.locExit(Sender: TObject);
begin
