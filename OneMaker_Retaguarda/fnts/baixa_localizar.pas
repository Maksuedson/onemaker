...
type
  Tfrmbaixa_localizar = class(TForm)
    ...
    procedure tyyr2258Click(Sender: TObject);
  private
...
procedure Tfrmbaixa_localizar.tyyr2258Click(Sender: TObject);
begin
...
procedure Tfrmbaixa_localizar.AdvSmoothExpanderPanel1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  ReleaseCapture;
