...
type
  Tfrmcheque_baixa = class(TForm)
    ...
    procedure uuuuyy5587Click(Sender: TObject);
  private
...
procedure Tfrmcheque_baixa.uuuuyy5587Click(Sender: TObject);
begin
...
procedure Tfrmcheque_baixa.AdvSmoothExpanderPanel1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  ReleaseCapture;
