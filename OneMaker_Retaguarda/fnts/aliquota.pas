...
type
  TfrmAliquota = class(TForm)
    ...
    Fechar1: TMenuItem;
    Panel1: TPanel;
    aliii01: TAdvGlowButton;
    ali0002: TAdvGlowButton;
    procedure FormShow(Sender: TObject);
    procedure FormClose(Sender: TObject; var Action: TCloseAction);
    procedure bcancelarClick(Sender: TObject);
    procedure BitBtn1Click(Sender: TObject);
    procedure aliii01Click(Sender: TObject);
    procedure ali0002Click(Sender: TObject);
  private
...
procedure TfrmAliquota.ali0002Click(Sender: TObject);
begin
  bcancelar.Click;
end;

procedure TfrmAliquota.aliii01Click(Sender: TObject);
begin
  BitBtn1.Click;
end;
