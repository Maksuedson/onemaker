...
procedure Tfrmlista_caixa2.AdvSmoothExpanderPanel1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  ReleaseCapture;
...
begin
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('\OneMaker\server\rel\f000071.fr3');
    fxcAIXA.ShowReport;
  end;
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('\OneMaker\server\rel\f000071_1.fr3');
    fxcAIXA.ShowReport;
  end;
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('\OneMaker\server\rel\f000072.fr3');
    fxcAIXA.ShowReport;
  end;
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('\OneMaker\server\rel\f000073.fr3');
    fxcAIXA.ShowReport;
  end;
