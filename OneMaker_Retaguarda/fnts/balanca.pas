...
uses
  ...
  ExtCtrls, Collection, TFlatPanelUnit, ComCtrls, DBTables, Menus,
  AdvGlowButton, RzPrgres, Vcl.Imaging.jpeg, AdvMetroButton, AdvSmoothPanel,
  AdvSmoothExpanderPanel, acPNG;
...
procedure Tfrmbalanca.AdvSmoothExpanderPanel1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  ReleaseCapture;
