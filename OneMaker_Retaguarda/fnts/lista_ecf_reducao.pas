...
begin
  ...
  begin
    ...
    FXNOTA.LoadFromFile('\Athenas\server\rel\f000092.fr3');
    FXNOTA.ShowReport;
  ...
  begin
    ...
    begin
      ...
      if combo_relatorio.Text = 'MAPA RESUMO ECF' then
        FXNOTA.LoadFromFile('\Athenas\server\rel\f000140.fr3')
      else
        FXNOTA.LoadFromFile('\Athenas\server\rel\f000140_1.fr3');
      FXNOTA.ShowReport;
    end
    else
    begin
