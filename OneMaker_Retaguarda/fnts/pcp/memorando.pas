...
uses
  ...
  RzBtnEdt, ZAbstractRODataset, ZAbstractDataset,
  ZDataset, RzCmboBx, ComCtrls, RzDTP, cxControls, cxContainer,
  cxEdit, cxTextEdit, cxMaskEdit, cxDropDownEdit, cxCalendar, CellEditors,
  JvMemoryDataset, System.ImageList, JvExMask, JvToolEdit;
...
type
  Tfrmmemorando = class(TForm)
    ...
    edata: TJvDateEdit;
    edespacho_data: TJvDateEdit;
    eregistro_data: TJvDateEdit;
    econhecimento_data: TJvDateEdit;
    ...
    edata_conhecimento: TJvDateEdit;
...
begin
  TJvDateEdit(sender).Color := $00A0FAF8;
