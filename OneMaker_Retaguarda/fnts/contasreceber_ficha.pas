...
type
  Tfrmcontasreceber_ficha = class(TForm)
    ...
    procedure ccti10Click(Sender: TObject);
  private
...
procedure Tfrmcontasreceber_ficha.AdvSmoothExpanderPanel1MouseDown(
...
procedure Tfrmcontasreceber_ficha.ccti10Click(Sender: TObject);
begin
  bcancelar.Click;
end;
