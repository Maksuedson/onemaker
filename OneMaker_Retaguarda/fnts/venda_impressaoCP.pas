...
begin
  ...
  begin
    ...
    frmmodulo.qrrelatorio.fieldbyname('linha6').asstring := IntToStr(frmvenda.qrvenda_produto.RecordCount);
    frmmodulo.qrrelatorio.post;
    FXvenda.LoadFromFile('c:\OneMaker\server\rel\f000048.fr3');
    FXvenda.ShowReport;
...
begin
  ...
  begin
    ...
    FXvenda.LoadFromFile('c:\OneMaker\server\rel\f000049.fr3');
    FXvenda.ShowReport;
    FXvenda.LoadFromFile('c:\OneMaker\server\rel\f000081.fr3');
    FXvenda.ShowReport;
...
begin
  ...
  begin
    ...
    frmmodulo.qrrelatorio.fieldbyname('linha6').asstring := IntToStr(frmvenda.qrvenda_produto.RecordCount);
    frmmodulo.qrrelatorio.post;
    FXvenda.LoadFromFile('c:\OneMaker\server\rel\f000048_1.fr3');
    FXvenda.ShowReport;
    FXvenda.LoadFromFile('c:\OneMaker\server\rel\f000049.fr3');
    FXvenda.ShowReport;
