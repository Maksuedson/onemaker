...
uses
  ...
  importa_NFENET in 'fnts\importa\importa_NFENET.pas' {FrmImporta_NFENET},
  industrializacao in 'fnts\pcp\industrializacao.pas' {frmindustrializacao},
  industrializacao_pedido in 'fnts\pcp\industrializacao_pedido.pas' {frmindustrializacao_pedido},
  industrializacao_pedido_inclui in 'fnts\pcp\industrializacao_pedido_inclui.pas' {frmindustrializacao_pedido_inclui},
  loc_produto_industria in 'fnts\pcp\loc_produto_industria.pas' {frmloc_produto_industria},
  memorando in 'fnts\pcp\memorando.pas' {frmmemorando},
  memorando_impressao in 'fnts\pcp\memorando_impressao.pas' {frmmemorando_impressao},
  memorando_menu in 'fnts\pcp\memorando_menu.pas' {frmmemorando_menu},
  agenda in 'fnts\agenda.pas' {frmagenda},
  agenda_ficha in 'fnts\agenda_ficha.pas' {frmagenda_ficha},
  sequencias in 'fnts\outros\sequencias.pas' {frmsequencias},
  agendamento in 'fnts\agendamento.pas' {frmagendamento},
  frmRelatoriosView_F in 'fnts\Relatorios\frmRelatoriosView_F.pas' {frmRelatoriosView},
  Unit1 in 'fnts\xml\Unit1.pas' {Frm_Download},
  UTDownloadXMLNFeDLL in 'fnts\xml\UTDownloadXMLNFeDLL.pas',
  Unit_ativar in 'fnts\Unit_ativar.pas' {Form_ativar},
  legendanfe in 'fnts\outros\legendanfe.pas' {Frm_legendaNfe};
...
begin
 ...
 // Evita carga dupla da aplicacao
  {begin
    HprevHist := FindWindow(nil, PChar('OneMaker'));
    if HprevHist <> 0 then
    begin
  ...
  Application.Title := 'OneMaker - Gerencial';
  Application.CreateForm(TfrmPrincipal, frmPrincipal);
  Application.CreateForm(Tfrmsplash, frmsplash);
  Application.CreateForm(TfrmNcm, frmNcm);
  Application.CreateForm(TFrmImporta_NFENET, FrmImporta_NFENET);
  Application.CreateForm(Tfrmindustrializacao, frmindustrializacao);
  Application.CreateForm(Tfrmindustrializacao_pedido, frmindustrializacao_pedido);
  Application.CreateForm(Tfrmindustrializacao_pedido_inclui, frmindustrializacao_pedido_inclui);
  Application.CreateForm(Tfrmloc_produto_industria, frmloc_produto_industria);
  Application.CreateForm(Tfrmmemorando, frmmemorando);
  Application.CreateForm(Tfrmmemorando_impressao, frmmemorando_impressao);
  Application.CreateForm(Tfrmmemorando_menu, frmmemorando_menu);
  Application.CreateForm(Tfrmagenda, frmagenda);
  Application.CreateForm(Tfrmagenda_ficha, frmagenda_ficha);
  Application.CreateForm(Tfrmsequencias, frmsequencias);
  Application.CreateForm(Tfrmagendamento, frmagendamento);
  Application.CreateForm(TfrmRelatoriosView, frmRelatoriosView);
  Application.CreateForm(TFrm_Download, Frm_Download);
  Application.CreateForm(TForm_ativar, Form_ativar);
  Application.CreateForm(TFrm_legendaNfe, Frm_legendaNfe);
