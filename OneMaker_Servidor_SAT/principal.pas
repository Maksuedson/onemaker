                  ...
                  begin
                    ...
                    begin
                      ...
                      // lancamento do caixa
                        ...
                        qrcaixa_mov.sql.add(':VALOR,:VALOR,''100001'',3,''Venda Nº  ' + qrpdv.fieldbyname('numero').asstring + ''')');
                  ...
                  begin
                    ...
                    begin
                      ...
                      // lancamento do caixa
                        ...
                        qrcaixa_mov.sql.add('values');
                        qrcaixa_mov.sql.add('(''' + codifica('000044', 7) + ''',''' + zerar(qrpdv.fieldbyname('cod_caixa').asstring, 6) + ''',''' + zerar(qrpdv.fieldbyname('cod_vendedor').asstring, 6) + ''',:datax,');
                        qrcaixa_mov.sql.add('0,:VALOR,''100002'',5,''Venda Nº  ' + qrpdv.fieldbyname('numero').asstring + ''')');
                        qrcaixa_mov.Params.ParamByName('datax').asdatetime := qrpdv.fieldbyname('data').asdatetime;
                  ...
                  begin
                    ...
                    begin
                      ...
                      begin
                        ...
                        if AnsiUpperCase(qrforma.fieldbyname('forma').asstring) = AnsiUpperCase('CARTÃO CRÉDITO') then
                      ...
                      // lancamento do caixa
                        ...
                        qrcaixa_mov.sql.add('(''' + codifica('000044', 7) + ''',''' + zerar(qrpdv.fieldbyname('cod_caixa').asstring, 6) + ''',''' + zerar(qrpdv.fieldbyname('cod_vendedor').asstring, 6) + ''',:datax,');
                        if AnsiUpperCase(qrforma.fieldbyname('forma').asstring) = AnsiUpperCase('CARTÃO CRÉDITO') then
                          qrcaixa_mov.sql.add(':VALOR,:VALOR,''100003'',7,''Venda Nº  ' + qrpdv.fieldbyname('numero').asstring + ''')')
                        else
                          qrcaixa_mov.sql.add(':VALOR,:VALOR,''100003'',8,''Venda Nº  ' + qrpdv.fieldbyname('numero').asstring + ''')');
                  ...
                  begin
                    ...
                    begin
                      ...
                      // lancamento do caixa
                        ...
                        qrcaixa_mov.sql.add('values');
                        qrcaixa_mov.sql.add('(''' + codifica('000044', 7) + ''',''' + zerar(qrpdv.fieldbyname('cod_caixa').asstring, 6) + ''',''' + zerar(qrpdv.fieldbyname('cod_vendedor').asstring, 6) + ''',:datax,');
                        qrcaixa_mov.sql.add('0,:VALOR,''100004'',4,''Venda Nº ' + qrpdv.fieldbyname('numero').asstring + ''')');
                        qrcaixa_mov.Params.ParamByName('datax').asdatetime := qrpdv.fieldbyname('data').asdatetime;
                        QRCAIXA_MOV.Params.ParamByName('VALOR').ASFLOAT := qrforma.fieldbyname('valor').asfloat;
//                      QRCAIXA_MOV.Params.ParamByName('VALOR').ASFLOAT := qrpdv.fieldbyname('valor_total').asfloat;
                        qrcaixa_mov.ExecSQL;
                  ...
                  begin
                    ...
                    begin
                      ...
                      // lancamento do caixa
                        ...
                        qrcaixa_mov.sql.add('values');
                        qrcaixa_mov.sql.add('(''' + codifica('000044', 7) + ''',''' + zerar(qrpdv.fieldbyname('cod_caixa').asstring, 6) + ''',''' + zerar(qrpdv.fieldbyname('cod_vendedor').asstring, 6) + ''',:datax,');
                        qrcaixa_mov.sql.add('0,:VALOR,''100005'',40,''Venda Nº  ' + qrpdv.fieldbyname('numero').asstring + ''')');
                        qrcaixa_mov.Params.ParamByName('datax').asdatetime := qrpdv.fieldbyname('data').asdatetime;
                        QRCAIXA_MOV.Params.ParamByName('VALOR').ASFLOAT := qrforma.fieldbyname('valor').asfloat;
//                      QRCAIXA_MOV.Params.ParamByName('VALOR').ASFLOAT := qrpdv.fieldbyname('valor_total').asfloat;
                        qrcaixa_mov.ExecSQL;
...
//                  qrpdv.sql.add('PRECO_ATACADO,');
                  ...
                  qrpdv.sql.add('IPPT,');
                  qrpdv.sql.add('SITUACAO,');
//                  qrpdv.sql.add('QTD_PROMOCAO,');
                  qrpdv.sql.add('NCM,');
                  qrpdv.sql.add('ALIQNACIONAL,');
                  qrpdv.sql.add('ALIQIMPORTADO,');
                  qrpdv.sql.add('ORIGEM,');
                  qrpdv.sql.add('csosn,');
                  qrpdv.sql.add('ALIQEST');
//                  qrpdv.sql.add('OP1,');
//                  qrpdv.sql.add('OP2');
...
//                  qrpdv.sql.add(':OP2');
                  ...
                  qrpdv.parambyname('DESCONTO_MAXIMO').asfloat := 0;
                  qrpdv.parambyname('SITUACAO').AsInteger := qrservidor_tabela.fieldbyname('SITUACAO').AsInteger;
                  qrpdv.parambyname('ORIGEM').AsInteger := qrservidor_tabela.fieldbyname('ORIGEM').AsInteger;
...
//                  qrpdv.parambyname('OP2').asstring := qrservidor_tabela.fieldbyname('OP2').asstring;
                  ...
                  begin
                    ...
                    QRPDV.ParamByName('ALIQIMPORTADO').Value :=
                      QRY_IBPT.FieldByName('aliqimp').Value;
                    QRPDV.ParamByName('ALIQEST').Value :=
                      QRY_IBPT.FieldByName('aliqestadual').Value;
                  end;
...
//                  qrpdv.sql.add('QTD_PROMOCAO = :QTD_PROMOCAO,');
                  ...
                  qrpdv.sql.add('ALIQimportado = :ALIQimportado,');
                  qrpdv.sql.add('ALIQest = :ALIQest,');
                  qrpdv.sql.add('origem = :origem,');
