...
uses
  ...
  ZipNfe in 'ZipNfe.pas' {FrmZipNfe},
  Gerador in 'Gerador.pas' {FrmSat},
  unPdv in 'unPdv.pas' {frmPdv},
  unVendasSat in 'unVendasSat.pas' {frmVendasSat},
  unConfig1 in 'unConfig1.pas' {frmConfig1};
...
begin
  ...
  Hand := FindWindow('TApplication', 'Sistema OneMaker - PDV SAT');

  // GUIO: 04/03/2010 - Caso não esteja, cria o formulário entra normalmente
  if Hand = 0 then
  begin
    Application.Initialize;
    Application.Title := 'OneMaker - PDV SAT';
