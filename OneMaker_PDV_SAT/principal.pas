...
uses
  ...
  Dialogs, StdCtrls, XPMan, Registry, ACBrBase, ACBrBAL, ACBrDevice, ACBrUtil,
  Menus, AdvMenus, DB, DBAccess, Grids, DBGrids, IniFiles, // unit de leitura do arquivo INI
  ...
  Uni, System.ImageList, MemDS, AdvSmoothButton;
...
type
  TfrmPrincipal = class(TForm)
    ...
    cpdsat01: TAdvGlowButton;
    cpdsat02: TAdvGlowButton;
    cpdsat03: TAdvGlowButton;
    cpdsat06: TAdvGlowButton;
    cpdsat05: TAdvGlowButton;
    cpdsat04: TAdvGlowButton;
    ...
    procedure bt_menu01Click(Sender: TObject);
    procedure bt_menu03Click(Sender: TObject);
    procedure bt_menu02Click(Sender: TObject);
    procedure bt_menu04Click(Sender: TObject);
    procedure bt_menu05Click(Sender: TObject);
    procedure bt_menu07Click(Sender: TObject);
    procedure bt_menu06Click(Sender: TObject);
    procedure AdvMetroButton1Click(Sender: TObject);
    procedure cySpeedButton1Click(Sender: TObject);
    procedure AdvSmoothButton6Click(Sender: TObject);
    procedure cpdsat01Click(Sender: TObject);
    procedure cpdsat04Click(Sender: TObject);
    procedure cpdsat02Click(Sender: TObject);
    procedure cpdsat05Click(Sender: TObject);
    procedure cpdsat03Click(Sender: TObject);
    procedure cpdsat06Click(Sender: TObject);
  private
...
var
  ...
  bSenha_Cancel_Cupom, satCompart: boolean; // exigir senha no cancelamento do cupom
...
uses modulo, funcoes, venda, senha, unECF, msg_Operador, config_ecf, unTEF,
  ...
  UtiSplash, UFuncoes, sobre, Unit_ativar, contasreceber, Gerador, unPdv;
...
procedure TfrmPrincipal.cpdsat01Click(Sender: TObject);
begin
  CarregaSistemaVenda;
end;

procedure TfrmPrincipal.cpdsat02Click(Sender: TObject);
begin
  frmconfig := tfrmconfig.create(self);
  frmconfig.showmodal;
end;

procedure TfrmPrincipal.cpdsat03Click(Sender: TObject);
begin
  Form_sobre := tForm_sobre.create(self);
  Form_sobre.showmodal;
end;

procedure TfrmPrincipal.cpdsat04Click(Sender: TObject);
begin
  frmconfig_balanca := tfrmconfig_balanca.create(self);
  frmconfig_balanca.showmodal;
end;

procedure TfrmPrincipal.cpdsat05Click(Sender: TObject);
begin
  if satCompart then
  begin
...
procedure TfrmPrincipal.cpdsat06Click(Sender: TObject);
begin
  close;
end;
...
procedure TfrmPrincipal.bt_menu03Click(Sender: TObject);
begin
  frmMenu_fiscal := tfrmMenu_fiscal.create(self);
  frmMenu_fiscal.showmodal;
end;

procedure TfrmPrincipal.bt_menu04Click(Sender: TObject);
begin
  frmconfig_balanca := tfrmconfig_balanca.create(self);
  frmconfig_balanca.showmodal;
end;

procedure TfrmPrincipal.bt_menu05Click(Sender: TObject);
begin
  frmConfig_ecf := tfrmConfig_ECF.create(self);
  frmconfig_ecf.showmodal;
end;

procedure TfrmPrincipal.bt_menu06Click(Sender: TObject);
begin
  Form_sobre := tForm_sobre.create(self);
  Form_sobre.showmodal;
end;
...
begin
  ...
  satCompart := StrToBool(frmPrincipal.LerIni(ExtractFilePath(Application.ExeName) +
    'CFG\cfg.ini', 'SAT', 'Compartilhamento', BoolToStr(false)));
        ...
        begin
          ...
          try
            ...
            Application.MessageBox
              (pwidechar('Não foi possível conectar ao banco de dados local!' +
...
begin
// imgFundo.Picture.LoadFromFile('c:\OneMaker\PDV\img\fundopdv.jpg');
end;
...
procedure TfrmPrincipal.bt_menu01Click(Sender: TObject);
begin
  CarregaSistemaVenda;
end;
...
begin
  CarregaSistemaVenda;  frmNotafiscal_menu := tfrmNotaFiscal_menu.create(self);
  frmNotafiscal_menu.showmodal;
end;
...
begin
  try
    ...
    if Pos(',', lForma_Cartao.CommaText) > 0 then
      frmmodulo.tbForma_PgtoNome.Value := copy(lForma_Cartao.CommaText, 2,
        Pos(',', lForma_Cartao.CommaText) - 3)
    else
      frmmodulo.tbForma_PgtoNome.Value := copy(lForma_Cartao.CommaText, 1,
        Length(lForma_Cartao.CommaText));
    frmmodulo.tbForma_pgto.Post;
    ...
    begin
      ...
      frmmodulo.tbForma_PgtoNome.Value := copy(lForma_Cartao.CommaText,
        Pos(',', lForma_Cartao.CommaText) + 2,
        Pos(',', lForma_Cartao.CommaText) - 4);
      frmmodulo.tbForma_pgto.Post;
    end;
