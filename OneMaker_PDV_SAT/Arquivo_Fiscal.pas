...
uses
  ...
  Dialogs, StdCtrls, Mask, ExtCtrls, DB, DBAccess, slstbox, dbslstbox, AdvScrollBox, XPMan, AdvGlowButton,
  AdvMetroButton, AdvSmoothPanel, AdvSmoothExpanderPanel, Uni, MemDS, JvExMask,
  JvToolEdit;
...
// -------------------------------------------------------------------------- //
procedure TfrmArquivo_Fiscal.AdvMetroButton1Click(Sender: TObject);
begin
  close;
end;
...
procedure TfrmArquivo_Fiscal.lblAvisoClick(Sender: TObject);
begin
