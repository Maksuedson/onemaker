...
// -------------------------------------------------------------------------- //
procedure TfrmMeios_Pagamento.AdvMetroButton1Click(Sender: TObject);
begin
  close;
end;

procedure TfrmMeios_Pagamento.bt_cancelar1Click(Sender: TObject);
begin
  close;
end;

// -------------------------------------------------------------------------- //
procedure TfrmMeios_Pagamento.bt_ok1Click(Sender: TObject);
var
  i: integer;
  sForma: string;
  rtotal: real;
