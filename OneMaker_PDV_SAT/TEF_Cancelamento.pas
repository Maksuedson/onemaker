...
uses
  ...
  Dialogs, StdCtrls, Buttons, Mask, ExtCtrls, Menus,
  AdvMenus, ComCtrls, XPMan, JvToolEdit, JvExMask, JvBaseEdits;
...
uses unTEF, menu_fiscal, funcoes, UFuncoes;
...
begin
    ...
    begin
      ...
      case iTEFTecban of
      0 : sTEFPath := SystemDrive + '\TEF_DIAL\';
      1 : sTEFPath := SystemDrive + '\TEF_DISC\';
      2 : sTEFPath := SystemDrive + '\HiperTEF\HiperLINK\';
      end;
