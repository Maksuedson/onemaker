...
begin
  ...
  try
    ...
    if (frmPrincipal.LerIni('.\Cfg\cfg_sat.ini', 'GUILHOTINA', 'MODELO', 'PADRÃO')
      = 'PADRÃO') or (frmPrincipal.LerIni('.\Cfg\cfg_sat.ini', 'GUILHOTINA',
...
begin
  ...
  begin
    ...
    Imp.Imprime(texto_justifica('Athenas 4.5', 48, ' ', taDireita), [t17cpi]);
