...
uses
  ...
  Dialogs, StdCtrls, Mask, ExtCtrls, DB, DBAccess, XPMan, AdvGlowButton, AdvMetroButton, AdvSmoothPanel,
  AdvSmoothExpanderPanel, Uni, MemDS, JvExMask, JvToolEdit;
...
// -------------------------------------------------------------------------- //
procedure TfrmLista_DAV.AdvMetroButton1Click(Sender: TObject);
begin
  close;
end;

procedure TfrmLista_DAV.bt_cancelar1Click(Sender: TObject);
begin
  close;
end;

// -------------------------------------------------------------------------- //
procedure TfrmLista_DAV.bt_ok1Click(Sender: TObject);
var
  txt: textfile;
...
begin
  ...
  begin
    ...
    try
      ...
      sNome_Arquivo := '.\txt\DAV_Emitidos.txt';
